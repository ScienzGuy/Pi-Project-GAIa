...
### Overview
GAIA is a specialized two-node sub-cluster engineered for private, localized Large Language Model (LLM) inference. The cluster is comprised of two Raspberry Pi 5 nodes—Io and Europa—operating in a unified bare-metal environment.
